...
//Shadow Stack store ptr in memory
FunctionPass *createX86ShadowStackMem();

// Shadow stack is at constant offset from the program stack
FunctionPass *createX86ShadowStackCon();

// Shadow Stack is stored in a register
FunctionPass *createX86ShadowStackReg();

//Shadow Stack is stored in a segment
FunctionPass *createX86ShadowStackSeg();

//This pass adds MPX protection
FunctionPass *createX86ShadowStackMPX();

//This pass counts function call
FunctionPass *createX86FunctionCountPass();
